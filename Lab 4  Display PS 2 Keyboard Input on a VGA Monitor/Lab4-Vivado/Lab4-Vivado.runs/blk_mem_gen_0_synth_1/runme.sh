...
HD_PWD='G:/My Drive/Classes/Fall 2023/FPGA Design/EEL5722-Projects/Lab 4  Display PS 2 Keyboard Input on a VGA Monitor/Lab4-Vivado/Lab4-Vivado.runs/blk_mem_gen_0_synth_1'
cd "$HD_PWD"
